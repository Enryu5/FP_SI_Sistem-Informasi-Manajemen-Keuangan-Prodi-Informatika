        ...
        <div className="flex w-full flex-col items-center mt-5">
            <div className="w-full max-w-12xl bg-white p-5 rounded-lg shadow-lg" >
                <div className="w-full mt-3 flex h-fit flex-col gap-5 lg:grid lg:grid-cols-12">
                        ...
                        <Card extra={"w-full h-full p-3"}>
                            ...
                            <div className="px-2 mb-8">
                                <div className="mb-4 flex items-center">
                                    <p className="text-sm text-gray-600 mr-2">Event name:</p>
                                    <p className="text-base font-bold text-navy-700 dark:text-white">{eventData.event}</p>
                                </div>
                                <div className="mb-4 flex items-center">
                                    <p className="text-sm text-gray-600 mr-2">Event status:</p>
                                    <p className="text-base font-bold text-navy-700 dark:text-white">{eventData.status}</p>
                                </div>
                                <div className="mb-4 flex items-center">
                                    <p className="text-sm text-gray-600 mr-2">Time range:</p>
                                    <p className="text-base font-bold text-navy-700 dark:text-white">{eventData["time range"]}</p>
                                </div>
                            </div>
                        </Card>
                    </div>
                        ...
                        <Card>
                            <div className="grid grid-cols-2 gap-12 p-4">
                                <div className="flex flex-col gap-2">
                                    <h4 className="text-lg font-bold text-navy-700 dark:text-white">Budget</h4>
                                    <div className="p-3 border border-gray-200 rounded-md min-w-fit">
                                        <p className="text-lg font-bold text-navy-700">Rp{eventData.budget ? eventData.budget.toLocaleString() : '0'}</p>
                                    </div>
                                </div>
                                <div></div>
                            </div>
                    ...
                    <div className="col-span-12 lg:!mb-0">
                        <Card extra={"w-full h-full p-3"}>
                            <h4 className="text-lg font-bold text-navy-700 dark:text-white mb-2">Expense</h4>
                            <div className="grid lg:grid-cols-3 items-center gap-4 justify-center">
                                    ...
                                    <div key={index} className="border border-gray-200 rounded-md p-3">
                                        <div className="flex justify-between items-center">
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <p className="text-navy-700 text-lg font-bold">Rp{category.expenseTarget ? category.expenseTarget.toLocaleString() : '0'}</p>
                                            </div>
                                            <button
                                ...
                                <div className="border border-gray-200 rounded-md p-3">
                                    <div className="flex justify-between items-center">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <p className="text-navy-700 text-lg font-bold">Rp7,500,000</p>
                                        </div>
                                        <button
                                            onClick={() => setIsModalOpen(true)}
                                            className="px-4 py-1 text-md font-medium text-brand-500 border border-brand-500 hover:bg-brand-500 hover:text-white rounded-md">
                                ...
                                <button
                                    onClick={() => setIsModalOpen(true)}
                                    className="h-full w-36 text-md font-medium text-brand-500 border border-brand-500 hover:bg-brand-500 hover:text-white rounded-md">
                                    Add category
                                </button>
                            </div>
                        </Card>
